...
class Param_State extends State<Param_groupe> {
  ...
  static const _popItem1 = <String>["Ajouter un voyage","Visualiser l'historique","Quitter le groupe"];
  /// pour les admins d'un normal
  static const _popItem2 = <String>["Ajouter des personnes", "Ajouter un voyage","Supprimer le groupe","Visualiser l'historique","Quitter le groupe"];
  /// pour les masters d'un groupe master
  static const _popItem3= <String>["Ajouter des personnes","Supprimer le groupe","Ajouter des masters","Quitter le groupe"];
                  ...
                  children: <Widget>[
                    Visibility
                      ...
                      IconButton(icon: Icon(Icons.delete), onPressed: () {
                        switch (widget.g.existMaster(widget.g.listMembres[index+1].compte.email)) {
                          case true: {
                            Firestore.instance.collection('users').document(widget.g.listMembres[index+1].compte.email).collection('liste de groupe').document(widget.g.id)
                                .delete().catchError((e) {
                              print(e.toString());
                            });
                            widget.g.listMembres[index+1].listeGroupes.remove(widget.g);
                            Firestore.instance.collection('groups').document(widget.g.id).collection('masters').document(widget.g.listMembres[index+1].compte.email)
                                .delete().catchError((e) {
                              print(e.toString());
                            });
                            widget.g.listMasters.remove(widget.g.listMembres[index+1]);
                            Firestore.instance.collection('groups').document(widget.g.id).collection('membres').document(widget.g.listMembres[index+1].compte.email)
                                .delete().catchError((e) {
                              print(e.toString());
                            });
                            widget.g.listMembres.remove(widget.g.listMembres[index+1]);
                        ...
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) =>Param_groupe(widget.p, widget.g) ));
                   ...
                   Image_pic2((widget.g.listMembres[index+1])),
                    Text(((widget.g.listMembres[index+1].compte.userName)!= null) ?widget.g.listMembres[index+1].compte.userName:"",
                    ...
                    Text(((widget.g.listMembres[index+1].compte.email!=null))? widget.g.listMembres[index+1].compte.email : "$index+1",
                      style: TextStyle
                        (
                        fontFamily: 'Gilroy-Light',
                        fontSize: 12,
        ...
        centerTitle: true,
          actions: <Widget>[
            PopupMenuButton<String>(
              icon: Icon(Icons.menu, color: Palette.background, size : 25,),

              onSelected: (String val) async{
                print("yyyyyyoooooooooooddddddddddddeeeeeeeeeeeeeeeeeeellllllllllllllllllllllll");
...
*/
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              Ajout_contact(widget.g, widget.p, li,"liste des membres", 0)),
                    );
                  }
                  ...
                  case "Ajouter des masters":
                    {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                Ajout_master(widget.g, widget.p, li,"liste des masters", 0)),
                      );
                    }
                  ...
                  case "Ajouter un voyage":
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CreerVoyage(widget.p,widget.g),
                        )
                    );
                  ...
                  case "Supprimer le groupe":
                    ...
                    crudObj.deleteDatauser(widget.p.getCompte().getEmail(), widget.g.id);
                    //////////////////////////////////////////////
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => PagePrincipale(widget.p)),
                    );
                  ...
                  case "Quitter le groupe": {
                    ...
                    switch (widget.g.existMaster(widget.p.compte.email)) {
                      case true: {
                        Firestore.instance.collection('users').document(widget.p.compte.email).collection('liste de groupe').document(widget.g.id)
                            .delete().catchError((e) {
                          print(e.toString());
                        });
                        widget.p.listeGroupes.remove(widget.g);
                        Firestore.instance.collection('groups').document(widget.g.id).collection('masters').document(widget.p.compte.email)
                            .delete().catchError((e) {
                          print(e.toString());
                        });
                        widget.g.listMasters.remove(widget.p);
                        Firestore.instance.collection('groups').document(widget.g.id).collection('membres').document(widget.p.compte.email)
                            .delete().catchError((e) {
                          print(e.toString());
                        });
              ...
              (widget.g.master)?((widget.g.existMaster(widget.p.compte.email))?pop3 : pop4):((widget.g.admin.compte.email==widget.p.compte.email)?pop2:pop1),
            ),
